...
Manuscripts will be submitted to [bioRxiv] while posters and slides will be
submitted to [figshare].
- *All activities* will be done in [RStudio].
- *Reproducibility* (more advanced and optional) {{use travis, set up a docker/rocker}}

### Managing files and tracking changes

All projects, files, coding, writing, and other activities will be done in
[RStudio]. RStudio is an exceptional environment to use [R] in
...
excellent [book on R package](http://r-pkgs.had.co.nz/) creation).
